...
'Latest Yahoo 9 Login - "1¿Äy4h00z.fyn3st_d34n0¿Ä0¿Äy4h00z.fyn3st_d34n0¿Ä277¿Äv=1&n=9pn8ngvpjrkd2&l=ou7qqp.5odtij_3tudq/o&p=m2k0c1p012000000&r=if&lg=en-NZ&intl=nz&np=1; path=/; domain=.yahoo.com¿Ä278¿Äz=7yIQJB74dQJB8eAKFz1SFf0MzI1BjZPM08zMzQzMjI-&a=QAE&sk=DAA4CN2XgqIX3w&ks=EAA_TZ0NnZGXHPff5bJXEwUHg--~C&d=c2wBTkRVeUFURTRORGcwTkRNME5UVS0BYQFRQUUBZwFITlhETjZGUFlRVkZMR1RGWVhQSFNUTlpXNAF6egE3eUlRSkJnV0EBdGlwAUtUTFlPRA--; path=/; domain=.yahoo.com¿Ä307¿Ä1yEFsoy.R432klvq7mkHbA--¿Ä244¿Ä4194239¿Ä2¿Äy4h00z.fyn3st_d34n0¿Ä2¿Ä1¿Ä59¿ÄB    bv79nmt4b44jr&b=4&d=AYaBpJppYEKS4UTsP2_zgFdd5sPXVfC3YfUmiQ--&s=tm¿Ä59¿ÄF    a=365sMRoMvTDwtTTJRz9YNsi5mL0Z87AbRRl.hNZmQ.br4P3q3c6Z4_42UV_63JfAcQl5LVk-&b=9OWr
'To Long For 1 Line!  -  ¿Ä59¿ÄT    z=ADIQJBAJdQJBUF5we1ox4yZMzI1BjZPM08zMzQzMjI-&a=QAE&sk=DAAIdP8MTcAHfT&ks=EAA2ZOkndSpiK2p1OWpHuqzkg--~C&d=c2wBTkRVeUFURTRORGcwTkRNME5UVS0BYQFRQUUBZwFITlhETjZGUFlRVkZMR1RGWVhQSFNUTlpXNAF6egFBRElRSkJnV0EBdGlwAUtUTFlPRA--¿Ä59¿ÄY    v=1&n=9pn8ngvpjrkd2&l=ou7qqp.5odtij_3tudq/o&p=m2k0c1p012000000&r=if&lg=en-NZ&intl=nz&np=1¿Ä98¿Äus¿Ä135¿Ä9.0.0.234 ¿Ä"
'^^^
'The ONLY PART I HAVE taken to Use Because im Not Using SSL - ¿Ä98¿Äus¿Ä135¿Ä9.0.0.234 ¿Ä  << AND >> ¿Ä2¿Ä1¿Ä
...
Packet = "6¿Ä" & Crip(0) & "¿Ä96¿Ä" & Crip(1) & "¿Ä0¿Ä" & YahooID & "¿Ä2¿Ä" & YahooID & "¿Ä2¿Ä1¿Ä1¿Ä" & YahooID & "¿Ä98¿Äus¿Ä135¿Ä9.0.0.234¿Ä"
'Packet = "6¿Ä" & Crip(0) & "¿Ä96¿Ä" & Crip(1) & "¿Ä0¿Ä" & YahooID & "¿Ä2¿Ä" & YahooID & "¿Ä192¿Ä-1¿Ä1¿Ä" & YahooID & "¿Ä135¿Ä8.1.0.249¿Ä148¿Ä480¿Ä"
'^^ THE FIRST PACKET I WAS USING TO BUILD THIS BEFORE UPDATING ITS PACKET TO THE LATEST
Log = YFHeader("54", Packet)
Debug.Print Log
End Function

'Packet = "1¿Äy4h00z.fyn3st_d34n0¿Ä"
'Header("57", Packet)
Public Function Get_Key(YahooID As String) As String
Dim Packet As String
Packet = "1¿Ä" & YahooID & "¿Ä"
